...
/**
 * Vista principal o "Buz�n de Entrada" para la gesti�n de correos electr�nicos.
 * Muestra una lista de mensajes recibidos en una tabla y permite la navegaci�n
 * hacia las funciones de redacci�n, lectura y refresco de datos.
 */
public class VistaGeneralCorreo extends JFrame {

	/** Panel principal que contiene la organizaci�n de la ventana. */
	private JPanel panel;

	/** Direcci�n de correo electr�nico del usuario actual. */
	private String correo;

	/** Bot�n para abrir la ventana de redacci�n de correos. */
	private JButton botonEnviarCorreo;

	/** Modelo de datos que gestiona las filas y columnas de la tabla. */
	private DefaultTableModel tablaModelo;

	/** Componente de tabla para la visualizaci�n de los correos. */
	private JTable emailTabla;

	/** Bot�n para regresar al men� principal de la aplicaci�n. */
	private JButton btnVolver;

	/** Bot�n para solicitar una nueva sincronizaci�n con el servidor de correo. */
	private JButton btnRefrescar;

	/** Etiqueta que identifica al usuario y el t�tulo de la secci�n. */
	...
	/**
	 * Constructor que inicializa la vista del buz�n de correo.
	 * * @param correo Direcci�n de correo electr�nico del usuario logueado.
	 */
	...
	/**
	 * Orquesta la configuraci�n inicial de componentes y estilos.
	 */
	...
	/**
	 * Configura los par�metros b�sicos del JFrame.
	 */
	...
	/**
	 * Crea los paneles superior e inferior y a�ade los botones de control.
	 */
	...
	/**
	 * Crea un bot�n con el estilo visual unificado de la aplicaci�n.
	 * * @param texto Etiqueta del bot�n.
	 * 
	...
	/**
	 * Carga una lista de correos en la tabla y los ordena cronol�gicamente.
	...
	/**
	 * Hace visible la ventana del buz�n.
	 */
	...
	/**
	 * Actualiza din�micamente los textos de la interfaz seg�n el idioma
	 * seleccionado.
	 */
	...
	/**
	 * Recupera el objeto Correo asociado a una fila espec�fica de la tabla visual.
	 *
	 * @param fila �ndice de la fila.
	 * @return El objeto Correo correpondiente o null si el �ndice es inv�lido.
	 */
	...
	/**
	 * Obtiene el bot�n de redacci�n de correo.
	 * 
	...
	/**
	 * Establece el bot�n de redacci�n.
	 * 
	 * @param botonEnviarCorreo Nuevo bot�n de composici�n.
	 */
	 ...
	 * 
	 * @param correo Nueva direcci�n de correo.
	 */
	...
	/**
	 * Obtiene el bot�n para volver al men� anterior.
	 * 
	 * @return Objeto JButton.
	 */
	...
	/**
	 * Establece el bot�n de retorno.
	 * 
	 * @param btnVolver Nuevo bot�n JButton.
	 */
	...
	/**
	 * Obtiene el bot�n de refresco de bandeja de entrada.
	 * 
	 * @return Objeto JButton.
	 */
	...
	/**
	 * Establece el bot�n de refresco.
	 * 
	 * @param btnRefrescar Nuevo bot�n JButton.
	 */
