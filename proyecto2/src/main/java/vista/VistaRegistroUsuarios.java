 ...
 * formulario detallado para capturar la informaci�n necesaria, permitiendo la
 * creaci�n de cuentas con credenciales de acceso y de correo.
 */
public class VistaRegistroUsuarios extends JFrame {
	...
	/** Referencia a la vista de administraci�n para la navegaci�n. */
	...
	/** Etiqueta para el campo de correo electr�nico. */
	private JLabel correo;

	/** Campo de texto para la direcci�n de correo. */
	private JTextField textCorreo;

	/** Etiqueta para el campo de clave de correo. */
	private JLabel claveCorreo;

	/** Campo de texto para la clave de aplicaci�n del correo. */
	private JTextField textClaveCorreo;

	/** Etiqueta para the campo de contrase�a. */
	private JLabel contrasena;

	/** Campo de texto oculto para la contrase�a de acceso. */
	private JPasswordField textContrasena;

	/** Etiqueta para la confirmaci�n de la contrase�a. */
	private JLabel confContrasena;

	/** Campo de texto oculto para confirmar la contrase�a. */
	private JPasswordField textConfContrasena;

	/** Bot�n para registrar el usuario. */
	private JButton aniadir;

	/** Bot�n para acceder a la funcionalidad de borrado. */
	private JButton eliminar;

	/** Bot�n para regresar a la vista administrativa. */
	private JButton volver;

	/** Imagen de fondo de la ventana. */
	private Image imagenFondo;

	/** Etiqueta del t�tulo principal en el panel. */
	...
	/**
	 * Orquesta la configuraci�n visual de la ventana y sus componentes internos.
	 */
	...
	/**
	 * Establece las propiedades b�sicas del marco de la ventana (JFrame).
	 */
	...
	/**
	 * Dise�a el panel central redondeado y distribuye los campos de entrada.
	 */
	...
	/**
	 * Configura los botones de acci�n principal y los posiciona en el panel
	 * central.
	 */
	...
	/**
	 * M�todo auxiliar para alinear y a�adir una etiqueta con su respectivo cam
	 * o.
	 */
	...
	/**
	 * Aplica el estilo visual unificado de la aplicaci�n a un bot�n.
	 */
	...
	/**
	 * Actualiza din�micamente los textos de las etiquetas y botones seg�n el
	 * idioma.
	 */
	...
	/**
	 * Obtiene el bot�n encargado de la eliminaci�n de usuarios.
	...
	/**
	 * Establece el bot�n encargado de la eliminaci�n de usuarios.
	...
	/**
	 * Obtiene el bot�n encargado de procesar el registro (a�adir).
	 * * @return El objeto JButton de a�adir.
	 */
	...
	/**
	 * Establece el bot�n encargado de procesar el registro.
	...
	/**
	 * Obtiene el bot�n para regresar a la vista anterior.
	...
	/**
	 * Establece el bot�n para regresar a la vista anterior.
	...
	/**
	 * Obtiene la referencia a la vista de administraci�n principal.
	...
	/**
	 * Establece la referencia a la vista de administraci�n principal.
	...
	/**
	 * Obtiene el campo de texto donde se ingresa el correo electr�nico.
	 * * @return El objeto JTextField.
	 */
	...
	/**
	 * Establece el campo de texto para el correo electr�nico.
	...
	/**
	 * Obtiene el campo de texto para la clave de aplicaci�n del correo.
	 * * @return El objeto JTextField.
	 */
	...
	/**
	 * Establece el campo de texto para la clave de aplicaci�n del correo.
	...
	/**
	 * Obtiene la etiqueta del campo Contrase�a.
	 * * @return El objeto JLabel.
	 */
	...
	/**
	 * Establece la etiqueta del campo Contrase�a.
	...
	/**
	 * Obtiene el campo de contrase�a de acceso al sistema.
	...
	/**
	 * Establece el campo de contrase�a de acceso.
	...
	/**
	 * Obtiene la etiqueta del campo Confirmar Contrase�a.
	 * * @return El objeto JLabel.
	 */
	...
	/**
	 * Establece la etiqueta del campo Confirmar Contrase�a.
	...
	/**
	 * Obtiene el campo para validar la contrase�a de acceso.
	 * * @return El objeto JPasswordField.
	 */
	...
	/**
	 * Establece el campo para validar la contrase�a de acceso.
