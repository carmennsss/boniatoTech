...
public class OyenteWhitelist implements ActionListener, MouseListener {
    ...
    /**
     * Maneja los eventos de acci�n (clics en botones).
     *
    ...
    /**
     * Maneja los clics del rat�n en la tabla para seleccionar usuarios.
     *
    ...
    /**
     * M�todo no implementado de la interfaz MouseListener.
     *
     * @param e El evento de rat�n.
     */
    @Override
