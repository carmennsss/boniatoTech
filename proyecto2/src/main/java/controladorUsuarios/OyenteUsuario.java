...
/**
 * Oyente que gestiona los eventos relacionados con el registro y eliminaci�n de
 * usuarios.
 */
public class OyenteUsuario implements ActionListener {
	...
	/** Vista de eliminaci�n de usuarios. */
	...
	/** Cliente FTP para operaciones de usuarios. */
	 ...
	 * @param vistaEliminarUsuarios Vista de eliminaci�n de usuarios.
	...
	/**
	 * Maneja los eventos de bot�n para a�adir o eliminar usuarios.
	 *
	...
	/**
	 * Rellena la tabla de eliminaci�n de usuarios con los datos actuales de la base
	 * de datos.
